      ...
      if (err) reject(err);
        ...
        const params = {
          ...
          IpPermissions: [
            {
              IpProtocol: 'tcp',
              FromPort: 22, // Allow SSH on port 22 / From-To is a range of ports
              ToPort: 22,
              IpRanges: [
                {
                  CidrIp: '0.0.0.0/0'
...
function createInstance(sgName, keyName) {
  const params = {
    ...
    // User data is the base64 encoding of marketplace-ec2-startup.sh file
